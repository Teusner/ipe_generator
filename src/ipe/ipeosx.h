...
#define IPE_AVAILABLE_10_9 __attribute__((availability(macosx,introduced=10_9)))
#define IPE_AVAILABLE_10_10 __attribute__((availability(macosx,introduced=10_10)))
...
#define IPE_AVAILABLE_10_12 __attribute__((weak_import,deprecated("API in 10.12")))
#define IPE_AVAILABLE_10_12_1 __attribute__((weak_import,deprecated("API in 10.12.1")))
#define IPE_AVAILABLE_10_12_2 __attribute__((weak_import,deprecated("API in 10.12.2")))
#define IPE_AVAILABLE_10_13 __attribute__((weak_import,deprecated("API in 10.13")))
#define IPE_AVAILABLE_10_13_4 __attribute__((weak_import,deprecated("API in 10.13.4")))
#define IPE_AVAILABLE_10_14 __attribute__((weak_import,deprecated("API in 10.14")))
#define IPE_AVAILABLE_10_15 __attribute__((weak_import,deprecated("API in 10.15")))
